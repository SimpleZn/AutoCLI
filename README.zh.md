...
从 [GitHub Releases](https://github.com/SimpleZn/autocli/releases/latest) 下载对应平台的文件：
...
1. 从 [GitHub Releases](https://github.com/SimpleZn/autocli/releases/latest) 下载 `autocli-chrome-extension.zip`
2. 解压到任意目录
